...
with opencontracts.enclave_backend() as enclave:
  ...
  paypalHash = enclave.keccak(seller, amount, message, secret, types=('string', 'uint256', 'string', 'string'))
  warning = f"""
  The information you entered would produce the paypalHash:
  {'0x' + paypalHash.hex()}
  ...
  enclave.submit(paypalHash, types=("bytes32",), function_name="paypalPurchase")
