...
with opencontracts.enclave_backend() as enclave:
  ...
  payment = enclave.interactive_session(url='https://www.w3schools.com/html/tryit.asp?filename=tryhtml_links_w3schools', parser=parser, instructions=instructions)
