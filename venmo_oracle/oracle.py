...
with opencontracts.enclave_backend() as enclave:
  ...
  service = "Venmo"   # allow user input one of multiple options in the future
  secret = enclave.user_input("Please enter the secret generated by the seller:")
  
  offerID = enclave.keccak(seller, amount, message, service, secret, types=('string', 'uint256', 'string', 'string', 'string'))
  warning = f"""
